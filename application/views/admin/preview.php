...
<head>
    ...
    <title>Thanks your feedback</title>
            ...
            <div class="h-100" style="background: linear-gradient(45deg, rgba(0, 255, 255, 0.2), rgba(255, 255, 255, 0.2), rgba(152, 255, 152, 0.2));">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= site_url('admin/todolist') ?>" class="sidebar-link">
                ...
                <div class="container-fluid">
                        <div class="card text-center">
                          <div class="card-header">
                            <h3><?= $todolist->title ? html_escape($todolist->title) : "No Title" ?></h3>
                          </div>
                          <div class="card-body">
                            <p class="card-text" ><?= $todolist->content ?></p>
                          </div>
                          <div class="card-footer text-muted">
                            Published at <?= $todolist->created_at ?>
                          </div>
                    </div>
                </div>
            </main>
