            ...
            <div class="h-100" style="background: linear-gradient(45deg, rgba(0, 255, 255, 0.2), rgba(255, 255, 255, 0.2), rgba(152, 255, 152, 0.2));">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= site_url('direksiview') ?>" class="sidebar-link">
                            ...
                            <table id="myTable" class="table table-striped" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action">
                                                <a href="<?= site_url('direksishow/'.$todolist->slug) ?>" class="button button-small"  role="button">Preview</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php endforeach ?>
                        ...
                        <div class="col-6 text-end">
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <a href="<? base_url("contact")?>" class="text-muted">Contact</a>
                                </li>
                            </ul>
                        </div>
                    </div>
