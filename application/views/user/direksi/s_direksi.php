            ...
            <div class="h-100" style="background: linear-gradient(45deg, rgba(0, 255, 255, 0.2), rgba(255, 255, 255, 0.2), rgba(152, 255, 152, 0.2));">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="<?= base_url('direksiview') ?>" class="sidebar-link">
                ...
                <div class="container-fluid">
                        <div class="card text-center">
                          <div class="card-header">
                            <h3><?= $direksi->title ? html_escape($direksi->title) : "No Title" ?></h3>
                          </div>
                          <div class="card-body">
                            <p class="card-text" ><?= $direksi->content ?></p>
                          </div>
                          <div class="card-footer text-muted">
                            Published at <?= $direksi->created_at ?>
                          </div>
                    </div>
                </div>
            </main>
