                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Judul to do list" required title="Wajib tulis judul to do list" required />
                                </div>
                                <div>
                                    <label for="content">Konten</label><br>
                                    <textarea name="content" class="form-control" cols="30" rows="5" placeholder="Apa yang ingin anda lakukan hari ini?"></textarea>
                                </div>
