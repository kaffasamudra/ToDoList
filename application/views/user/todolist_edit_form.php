                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div>
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Judul to do list" value="<?= $todolist->title ?>" required />
                                </div>
                                <div>
                                    <label for="content">Konten</label><br>
                                    <textarea name="content" class="form-control" cols="30" rows="5" placeholder="write your message" required><?= $todolist->content ?></textarea>
                                </div>
